...
from hjbgnn.utils.typing import Action, Params, PRNGKey, Array
from hjbgnn.utils.graph import GraphsTuple
from hjbgnn.utils.utils import merge01, jax_vmap, tree_merge
from hjbgnn.trainer.data import Rollout
from hjbgnn.trainer.buffer import ReplayBuffer
from hjbgnn.trainer.utils import has_any_nan, compute_norm_and_clip
from hjbgnn.env.base import MultiAgentEnv
from hjbgnn.algo.module.cbf import CBF
from hjbgnn.algo.module.policy import DeterministicPolicy
...
class GCBF(MultiAgentController):
    ...
    def load(self, load_dir: str, step: int):
        ...
        if os.path.exists(os.path.join(path, 'value.pkl')):
            print('please use hjb_gnn model')
            exit()
