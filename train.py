...
from hjbgnn.algo import make_algo
from hjbgnn.env import make_env
from hjbgnn.trainer.trainer import Trainer
from hjbgnn.trainer.utils import is_connected
...
def train(args):
    ...
    algo = make_algo(
        ...
        loss_value_coef=args.loss_value_coef,
...
def main():
    ...
    parser.add_argument("--algo", type=str, default="hjb_gnn")
    parser.add_argument("--env", type=str, default="CrazyFlie")
    ...
    parser.add_argument("--lr-cbf", type=float, default=1e-4)
    parser.add_argument("--loss-action-coef", type=float, default=1e-3)
    parser.add_argument("--loss-value-coef", type=float, default=1e-4)
